...
function FReward(_position, _mass) 
{
	this.Parent = null;
...
/**
*Apply a Mass to the FReward
**/

FReward.prototype.SetMass = function(_mass) 
{
	this.mass = _mass || 50;
...
/**
*
* Updates he values of the FReward
*
**/

FReward.prototype.Update = function() 
{
	if (this.Parent != null) 
	{
...
FReward.prototype.Render = function()
{
